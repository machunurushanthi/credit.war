...
--
-- Administration User for the schema `credit`
--

DROP USER IF EXISTS 'credit'@'localhost';
CREATE USER 'credit'@'localhost' IDENTIFIED BY 'credit' PASSWORD EXPIRE NEVER;
GRANT ALL ON `credit`.* TO 'credit'@'localhost';
GRANT SELECT, INSERT ON `credit`.* TO 'credit'@'localhost';
